...
(function ($) {
  $.fn.tableExport = function (options) {
    ...
    if (defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type === 'txt') {
      ...
      ranges = [];
      var tdData =
        'INSERT INTO ' + defaults.sql.tableEnclosure + defaults.tableName + defaults.sql.tableEnclosure + ' (';
      ...
      // all
      else sdata = JSON.stringify({ header: jsonHeaderArray, data: jsonArray });
      ...
      saveToFile(
        xlsxWorkbookToArrayBuffer(wbout),
              ...
              if (typeof atOptions.createdHeaderCell !== 'function') {
                ...
                atOptions.createdHeaderCell = function (cell, data) {
                  ...
                  if (typeof teOptions.columns[data.column.dataKey] !== 'undefined') {
                    ...
                    if (typeof col.rect !== 'undefined') {
                      ...
                      if (typeof teOptions.heightRatio === 'undefined' || teOptions.heightRatio === 0) {
                        if (data.row.raw[data.column.dataKey].rowspan)
                          rh =
                            data.row.raw[data.column.dataKey].rect.height / data.row.raw[data.column.dataKey].rowspan;
                    ...
                    cell.styles.halign =
                      atOptions.headerStyles.halign === 'inherit' ? 'center' : atOptions.headerStyles.halign;
            ...
            $.each(html, function () {
              if ($(this).is('input')) {
                ...
                if ($(this).is('a')) {
                  ...
                  else if (defaults.htmlHyperlink === 'href') result += href;
                  // 'content'
    ...
    function xlsxTableToSheet(table) {
      ...
      for (; _R < rows.length && R < sheetRows; ++_R) {
        ...
        if (
          ignoreRow === true ||
          (defaults.ignoreRow.length !== 0 &&
            ($.inArray(_R, defaults.ignoreRow) !== -1 || $.inArray(_R - rows.length, defaults.ignoreRow) !== -1)) ||
          isVisible($(row)) === false
        ) {
          continue;
        }
        ...
        for (_C = C = 0; _C < elts.length; ++_C) {
          ...
          if (v != null) {
            ...
            } else if (cellInfo.type === 'function') o = { f: v };
      ...
      if (R >= sheetRows) ws['!fullref'] = xlsxEncodeRange(((range.e.r = rows.length - _R + R - 1), range));
      return ws;
    }
